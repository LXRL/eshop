<template>
    <div class="sortClass">
        ...
        <div class="right">
            <sort-class-right title="潮流女装"></sort-class-right>
        </div>
    </div>
</template>
...
const { sortClass } = storeToRefs(sortStore)
sortStore.fetchAllSortClassData()

// const classPhone = props.shopping.value.filters(item => item.shopclass == "手机数码")
</script>
