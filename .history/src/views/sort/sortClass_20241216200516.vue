<template>
    <div class="sortClass">
        ...
        <div class="right" v-if="classPhone">
            ...
            <sort-class-right title="手机数码" :data="classCostume"></sort-class-right>
            <sort-class-right title="手机数码" :data="classDepartment"></sort-class-right>
            <sort-class-right title="手机数码" :data="classSports"></sort-class-right>
            <sort-class-right title="手机数码" :data="classFood"></sort-class-right>
            <sort-class-right title="手机数码" :data="classFruit"></sort-class-right>
        </div>
    </div>
</template>
