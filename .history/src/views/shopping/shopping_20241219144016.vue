...
const handleCheckout = () => {
    ...
    if (confirmDelete) {
        const selectedItems = shoppingData.value.filter(item => item.choose == true)
        meReceive.value = selectedItems.values
        console.log('选中商品', meReceive.value)
    }
